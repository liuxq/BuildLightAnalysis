...
BOOL CMainFrame::CreateDockingWindows()
{
	...
	if (!m_wndWindowProperties.Create(_T("窗户"), this, CRect(0, 0, 200, 200), TRUE, ID_VIEW_WINDOW_PROPERTIESWND, WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | CBRS_RIGHT | CBRS_FLOAT_MULTI))
	{
		TRACE0("Failed to create Option window\n");
		return FALSE; // failed to create
	}
